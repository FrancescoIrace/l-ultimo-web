...
// Mock di domande tematiche
const MOCK_QUESTIONS = [
  { 
    id: 1, 
    question: "Quanto dura un tempo in una partita di calcio a 11 regolamentare?", 
    options: ["40 minuti", "45 minuti", "50 minuti", "60 minuti"], 
    correctIndex: 1 
  },
  { 
    id: 2, 
    question: "Nel basket, quanti punti vale un tiro libero?", 
    options: ["1 punto", "2 punti", "3 punti", "Nessun punto"], 
    correctIndex: 0 
  },
  { 
    id: 3, 
    question: "Chi è considerato il 'Re' del basket NBA con il record di punti all-time?", 
  ...
  },
  {
    ...
    options: ["Chi ha risposto nel game precedente", "Chi ha servito nel game precedente", "Si sorteggia di nuovo", "Sempre il giocatore di destra"],
    correctIndex: 0
  }
];
  ...
  useEffect(() => {
    const initGame = async () => {
      try {
        ...
        // Check record su daily_game_attempts
        ...
        if (attempt) {
          ...
          // Seleziona 3 domande casuali uniche
